...
public class Config {
    ...
    public static final String LOG_STORAGE_LOCATION = "/home/chris/Downloads/" + PERSISTENCE_UNIT_NAME + "_crud_performance.txt";
    public static final Integer TRANSACTION_TIMEOUT = 900000;
    public static final String PERSIST_STORAGE_LOCATION = "/home/chris/Downloads/customers.txt";
    public static final String PERSIST_STORAGE_OUTPUT_LOCATION = "/home/chris/Downloads/customers_out.txt";
